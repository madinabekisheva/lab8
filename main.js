...
let total_score = ((sums[0] + sums[1] + sums[2] + sums[3] + sums[4]) / 240 * 100 * 0.6 + quiz1 / 40 * 100 * 0.4);

const results = {
  lab1: [5, 5, 0, 0, 5, 0, 10],	// array of scores for lab1
  lab2: [4, 5, 5, 5, 5, 5, 10],   	// array of scores for lab2
